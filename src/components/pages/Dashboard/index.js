...
import { Table, Button, Form, FormGroup, Label, Input, Alert, Row } from "reactstrap";
...
class AtualizarDadosUsuario extends Component {
    ...
    create = () => {
        this.setState({ model: { nome: "", dataNascimento: "", cep: "", telefone: "", genero: "" } });
                    ...
                    <FormGroup>
                        <div className="form-row">
                            ...
                            <Input
                                id="dataNascimento"
                                type="date"
                                value={this.state.model.dataDeNascimento}
            ...
            <div>
                ...
                <div className="row">
                    <div className="col-md-6 my-3">
                        <h2 className="font-weight-bold text-center">ATUALIZAR DADOS DE USUARIO</h2>
